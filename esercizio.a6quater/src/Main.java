...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        for (int i=0;i<questions.length;i++) { //Loop per le domande
            ...
            while (!inputIsOk) {
                try {
                    ...
                    if (answer.equals(si) || answer.equals(no) || answer.isEmpty())
                    {
                        inputIsOk = true;
                        answers.add(answer);
                    }
        ...
        else if (answers.get(0).equals("") && answers.get(1).equals(si) && answers.get(2).equals(no) && answers.get(3).equals(no)){
            System.out.println("Puoi uscire");
        }
        else if (answers.get(0).equals(si) && answers.get(1).equals("") && answers.get(2).equals(no) && answers.get(3).equals(no)){
            System.out.println("Puoi uscire");
        }
        else if (answers.get(0).equals(si) && answers.get(1).equals(si) && answers.get(2).equals("") && answers.get(3).equals(no)){
            System.out.println("Puoi uscire");
        }
        else if (answers.get(0).equals(si) && answers.get(1).equals(si) && answers.get(2).equals(no) && answers.get(3).equals("")){
            System.out.println("Puoi uscire");
        }
        else {
